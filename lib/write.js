      ...
      if(options.relationship){
        ...
        options.relationship.forEach(function(element, index){
          if(!element.direction || !element.type || !element.indexField ||
           !element.indexValue  || !element.nodeLabel){
...
function parseSubSchema(data, schema, level, relationship, parent, tag){
  ...
  data.forEach(function(element){
    ...
    //   //update this
    //   console.log('called')
    //   updateCypher = updateSchemaCypher(element, schema, level, count, relationship, parent, tag)
    // }
    // else {
      createCypher = createSchemaCypher(element, schema, level, count, relationship, parent, tag);
...
module.exports.update = function(node, updates, options, callback){
  ...
  // recurse through subschema updates
  var response = parseSubSchema(updates, this.schema);
